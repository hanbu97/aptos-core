module nft::mint {
    ...
    fun init_module(origin: &signer, collection_name: String, description: String, collection_uri: String, token_name: String, token_uri: String, expiration_timestamp: u64, public_key_bytes: vector<u8>) {
        ...
        let token_data_id = token::create_tokendata(
            ...
            0,
            0,
            [false, false, false, false, true], // we don't allow any mutation to the token
            vector<String>[],
            vector<String>[],
            vector<String>[],
        );
